...
const MCP_TOOL_PERMISSIONS: Record<string, string> = {
  ...
  archive_item: 'edit_item',
  unarchive_item: 'edit_item',
  create_workspace: 'manage_workspaces',
  update_workspace: 'manage_workspaces',
  delete_workspace: 'manage_workspaces',
  create_type: 'manage_types',
  update_type: 'manage_types',
  delete_type: 'manage_types',
  add_type_action: 'manage_types',
  remove_type_action: 'manage_types',
  ...
  delete_action: 'manage_actions',
  delete_submission: 'manage_actions',
  get_submission_stats: 'manage_actions',
  export_submissions: 'manage_actions',
};
